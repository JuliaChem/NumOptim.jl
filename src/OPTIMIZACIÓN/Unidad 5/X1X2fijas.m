...
Xo={1,3,5,7,9};      %% CONDICIONES INCIALES
XI1=[1,3]';          %% VALOR DE XI
XD1=[5,7,9]';        %% VALOR DE XD
% Xo={.9513,-39.60,6.61,6.99,2.10};
% XI1=[.9513,-39.60]';
% XD1=[6.61,6.99,2.10]';
tam=length(xi);
tem=length(xd);
...
Xorign=[XI1(1,1),XI1(2,1),XD1(1,1),XD1(2,1),XD1(3,1)]'
F_Xnueva=vpa(subs(fx,{x1,x2,x3,x4,x5},{XI(1,1),XI(2,1),XD(1,1),XD(2,1),XD(3,1)}))
F_Xorign=vpa(subs(fx,{x1,x2,x3,x4,x5},Xo))
for i=1:length(h)
Hrest(i,:)=vpa(subs(h(i),xx_var,{XI(1,1),XI(2,1),XD(1,1),XD(2,1),XD(3,1)}));
end
Hrest